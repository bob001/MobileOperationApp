...
//        initList();
        ...
        qxlistAdapter = new QiangXiuListAdapter(this, R.layout.listviewitem_repairlist, repairInfoList);
...
//        String baseaddress = "http://dsm.swdnkj.com:9080/EIS/rest/patrol/getQXList?usercode=";
        String baseaddress = "http://61.177.76.218:8090/boyuan/rest/patrol/getQXList?usercode=";
