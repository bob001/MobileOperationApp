...
public class OrderHandle extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qiangxiu_order_handle);
    ...
    private void initView() {
        ...
        tvProcess = (TextView)findViewById(R.id.tv_repair_orderHandle);
    }
...
//        String address = "http://dsm.swdnkj.com:9080/EIS/rest/patrol/setqxcontent";
        String address = "http://61.177.76.218:8090/boyuan/rest/patrol/setqxcontent";
